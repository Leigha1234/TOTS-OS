          ...
          <div className="bg-white rounded-[3.5rem] w-full max-w-2xl p-12 animate-in zoom-in-95 duration-300 shadow-2xl relative">
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                ...
                <textarea 
                  className="w-full h-32 bg-stone-50 rounded-3xl p-6 outline-none font-serif italic text-sm focus:bg-white border-2 border-transparent focus:border-stone-100 transition-all" 
                  onChange={e => setAppraisalForm({...appraisalForm, q1: e.target.value})} 
