              ...
              <div className="tots-sec-grid">
                <div>
                  ...
                  <p style={{ marginTop: 20, maxWidth: 480, fontSize: 14, lineHeight: 1.75, color: "var(--ink-dim)" }}>
                    TOTS-OS gives your business a dedicated, account-based workspace for keeping operational
        ...
        <div className="tots-wrap-narrow">
          <Reveal>
            ...
            <p style={{ margin: "30px auto 0", maxWidth: 680, fontSize: 15, lineHeight: 1.85, color: "var(--ink-dim)" }}>
              TOTS-OS was built around a simple idea: running a small business shouldn&apos;t require endless
              subscriptions, scattered spreadsheets, forgotten notes and a dozen tabs open just to understand
              what&apos;s going on.
            </p>
            <p style={{ margin: "18px auto 0", maxWidth: 680, fontSize: 15, lineHeight: 1.85, color: "var(--ink-dim)" }}>
              We&apos;re building one organised place for the work behind the business — so founders spend less time
              managing their systems, and more time building what matters.
            </p>
          </Reveal>
        </div>
      </section>
          ...
          <div className="tots-cta-card">
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="tots-cta-form">
                ...
                />
                <button type="submit" className="tots-btn-solid" style={{ minHeight: 50, justifyContent: "center" }}>
                  Join updates
                  <ArrowRight size={13} />
                </button>
              </form>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                style={{ margin: "30px auto 0", maxWidth: 380, border: "1px solid rgba(215,224,168,0.2)", background: "var(--accent-soft)", borderRadius: 16, padding: 18 }}
              >
        ...
        <div className="tots-wrap-narrow tots-faq-grid">
          <Reveal>
            ...
            <a
              ...
              style={{ marginTop: 22, display: "inline-flex", alignItems: "center", gap: 8, fontSize: 12.5, color: "rgba(243,244,238,0.7)", textDecoration: "none" }}
            >
              Contact us
              <ArrowUpRight size={14} />
            </a>
              ...
              return (
                <Reveal key={faq.q} delay={index * 0.03}>
                  <div className="tots-faq-item">
                    <button type="button" className="tots-faq-btn" onClick={() => setOpenFaq(open ? null : index)}>
                      <span>{faq.q}</span>
