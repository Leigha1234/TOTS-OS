...
// ============================================================
//
// GET only verifies the token and shows a confirmation page.
//
// It deliberately DOES NOT unsubscribe the recipient.
//
// Email security scanners often automatically open links inside
// emails. Requiring a POST prevents those scanners from
// accidentally unsubscribing recipients.
// ============================================================
...
export async function POST(
  ...
  try {
    ...
    //
    // Once an email is added here, campaign sending should
    // exclude it from ALL future marketing campaigns for this
    // organisation — even if someone manually imports the
    // address into another list later.
    // ========================================================
    ...
    if (
      ...
      // Mark the profile itself as unsubscribed.
      ...
      // Remove profile from the list the campaign was sent to.
